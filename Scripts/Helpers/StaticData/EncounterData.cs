...
public static class EncounterData
{
    public static readonly Dictionary<EncounterType, EncounterInfo> InfoMap = new()
    {
        ...
        { EncounterType.Hold_The_Line_Encounter, new EncounterInfo("UI/Art/Icons/tank_encounter_icon", "Hold the Line", "Survive the onslaught of attacks to claim the rewards.") },
